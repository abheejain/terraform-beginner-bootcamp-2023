...
When attempting to run `terraform login` it will launch bash a WYSIWYG view to generate a token. However, it does not work expected in Gitpod VsCode in the browser.
